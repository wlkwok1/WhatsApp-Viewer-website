                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <div class="p-5">
                                      ...
                                      <form class="user" action="user_password_reset.php?user_id=<?php echo $_GET['user_id']?>" method="post">
												<div class="form-group"> Old password: <input type="password" class="form-control form-control-user" name="old_password" placeholder="old password" required></div>
												<div class="form-group"> New password: <input type="password" class="form-control form-control-user" name="new_password" placeholder="new password" required></div>
												<div class="form-group"> Confirm password: <input type="password" class="form-control form-control-user" name="confirm_password" placeholder="confirm password" required></div>
                                          <hr>
