...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">Account Information</h1>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><?PHP echo $_GET["admin_id"] ?> Account Information </h6>
                        </div>
                        <div class="card-body">
                            <?PHP
                            ...
                            if($rows){//0 false 1 true
                                ...
                                {
                                    echo '<p class="text-gray-900 p-3 m-0">ID: ';echo $row['admin_id'];echo '</p>';
                                    echo '<p class="text-gray-900 p-3 m-0">Name: ';echo $row['admin_name'];echo '</p>';
                                    echo '<p class="text-gray-900 p-3 m-0">Phonenumber: ';echo $row['phone_number'];echo '</p>';
                                    echo '<p class="text-gray-900 p-3 m-0">Department: ';echo $row['department'];echo '</p>';
									echo '<p class="text-gray-900 p-3 m-0">Address: ';echo $row['address'];echo '</p>';
									echo '<br>';
									echo '<input type="button" value="update profile" onclick="',
										'location.href=',
										"'",
										'Admin_Account_modification.php?admin_id=',
										$_GET["admin_id"],
										"'",
										'">';
                                }
                            }else{
                                echo '<p class="text-gray-900 p-3 m-0">null</p>';
                            }?>
                        </div>
                    </div>
                </div>
  ...
  <script>
      function search_message() {
          ...
          location.href='search_admin.php?admin_id='+hash_Text+'&submit='+document.getElementById("submit")+'&data='+document.getElementById("data");
      }
  </script>
</body>
