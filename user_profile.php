                ...
                <div class="col-xs-12 col-sm-6 col-md-8">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><?PHP echo $_GET["user_id"] ?> Account Information</h6>
                        </div>
                        <div class="card-body">
                            <?PHP
                            ...
                            if($rows){//0 false 1 true
                                ...
                                {
									echo '<p class="text-gray-900 p-3 m-0">ID: ';echo $row['user_id'];echo '</p>';
                                    echo '<p class="text-gray-900 p-3 m-0">Name: ';echo $row['user_name'];echo '</p>';
									...
									'location.href=',
									"'",
									'Account_modification.php?user_id=',
									$_GET["user_id"],
									"'",
									'">';
                                }
