                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <div class="p-5">
                                      ...
                                      <form class="user" action="Account_reset.php?user_id=<?php echo $_GET['user_id']?>" method="post">
                                          <?PHP
                                          ...
                                          if($rows){//0 false 1 true
                                              ...
                                              {
                                                  echo '<div class="form-group">','Name: <input type="text" class="form-control form-control-user" name="user_name" placeholder="user_name" value="', $row['user_name'],'"required>','</div>';
