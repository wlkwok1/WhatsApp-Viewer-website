...
<head>
    ...
    <title>Chat Room Statistics</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Chat Room Data Statistics</h1>
                <p class="mb-4"></p>
                <!-- Topbar Search -->
                ...
                data: [
                    {
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                $String_time=explode(":",$row["time"]);
                                $time=intval($String_time[0]);
                                if(0<=$time&&$time<3){
                                    $time0++;
                        ...
                        echo 'type: "column",';
                        echo ' dataPoints: [';
                        echo ' { label: "0~3",  y: ',$time0,'  },';
                        echo ' { label: "3~6", y: ',$time3,'  },';
                        echo ' { label: "6~9", y: ',$time6,'  },';
                        echo ' { label: "9~12",  y: ',$time9,'  },';
                        echo ' { label: "12~15",  y: ',$time12,'  },';
                        echo ' { label: "15~18", y: ',$time15,'  },';
                        echo ' { label: "18~21", y: ',$time18,'  },';
                        echo ' { label: "21~24", y: ',$time21,'  }]';
                        ?>
                    }
                ]
            });
