...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Set Permission</h1>
          <p class="mb-4"></p>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    $sql_outside = "SELECT DISTINCT * FROM user";
                    ...
                    if (mysqli_num_rows($result_outside) > 0) {
                        while ($row_outside = mysqli_fetch_assoc($result_outside)) {
                            echo '<tr>';
                            echo '<td>';echo $row_outside['user_name'];echo '</td>';
                            echo '<td>';echo $row_outside['department'];echo '</td>';
                            $sql = "select * from permission where groupchat_id='{$_GET['groupchat_id']}' and user_id='{$row_outside["user_id"]}'";
                            $result = mysqli_query($con,$sql);//执行sql
                            $rows=mysqli_num_rows($result);//返回一个数值
                            if($rows){//0 false 1 true
                                echo '<td> <input type="button" value="delete permission" onclick="',
                                'location.href=',
                                "'",
                                'Delete_permission.php?groupchat_id=',
                                $_GET['groupchat_id'],
                                '&user_id=',
                                $row_outside["user_id"],
                                '&admin_id=',
                                ...
                                echo '<td> <input type="button" value="add permission" onclick="',
                                'location.href=',
                                "'",
                                'Add_permission.php?groupchat_id=',
                                $_GET['groupchat_id'],
                                '&user_id=',
                                $row_outside["user_id"],
                                '&admin_id=',
