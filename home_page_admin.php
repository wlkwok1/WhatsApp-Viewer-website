...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Chat Room</h1>
          <p class="mb-4"></p>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    $sql_outside = "SELECT DISTINCT * FROM whatsapp_groupchat";
                    ...
                    if (mysqli_num_rows($result_outside) > 0) {
                        while ($row_outside = mysqli_fetch_assoc($result_outside)) {
                            echo '<tr><td>Chatroom name</td><td colspan="3">';
                            echo $row_outside['chatroom_name'];
							echo '</td></tr>';
							
							echo '<tr><td >Description</td><td colspan="3">';
                            echo $row_outside['Description'];
                            echo '</td></tr>';
							
							echo '<tr><td >department</td><td colspan="3">';
                            echo $row_outside['department'];
                            echo '</td></tr>';
                            
                            echo '<tr><td >chatroom Data</td><td colspan="3">';
                            echo '<input type="button" value="chatroom Data" onclick="',
                            'location.href=',
                            "'",
                            'chatroom_Data_admin.php?admin_id=',
                            $_GET["admin_id"],
                            '&groupchat_id=',
							...
							echo '<tr><td >permission setting</td><td colspan="3">';
                            echo '<input type="button" value="permission setting" onclick="',
                            'location.href=',
                            "'",
                            'permission.php?groupchat_id=',
                            $row_outside['groupchat_id'],
                            '&admin_id=',
                            $_GET["admin_id"],
                            "'",
