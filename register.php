                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <div class="p-5">
                                      ...
                                      <form class="user" action="signup.php?admin_id=<?php echo $_GET['admin_id']?>" method="post">
											
                                          <div class="form-group">
                                              Name: <input type="text" class="form-control form-control-user" name="user_name" placeholder="user_name" required>
                                          </div>
                                          <div class="form-group">
                                              Phonenumber: <input type="text" class="form-control form-control-user" name="phone_number" placeholder="phone_number" required>
                                          </div>
                                          <div class="form-group">
                                              Department: <input type="text" class="form-control form-control-user" name="department" placeholder="department" required>
                                          </div>
                                          <div class="form-group">
                                              Address: <input type="text" class="form-control form-control-user" name="address" placeholder="address" required>
                                          </div>
                                          <div class="form-group">
                                              Password: <input type="password" class="form-control form-control-user" name="password" placeholder="Password" required>
                                          </div>
                                          <hr>
                                          <input  type="submit" name="submit" value="user"  class="btn btn-primary btn-user btn-block">
                                          <input  type="submit" name="submit" value="admin" class="btn btn-google btn-user btn-block">
                                  </div>
                                  </form>
                                  <hr>
                              </div>
